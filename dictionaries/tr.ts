export const tr = {
  ...
  analysis: {
    ...
    high: "Yüksek",
    title: "Duygu Analizi",
    subtitle: "Yerel rekabet setine göre işletmenizin kıyaslaması.",
    backToOverview: "Genel Bakışa Dön",
    comparingWith: "Karşılaştırılan:",
    noDataAvailable: "Otel verisi bulunamadı. Lütfen önce hedef otel ekleyin.",
    myHotel: "Otelim",
    leader: "Lider",
    avgComp: "Pazar Ort.",
    rankSuffix: {
