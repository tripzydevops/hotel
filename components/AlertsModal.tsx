...
import { X, Bell, Trash2, CheckCircle, ExternalLink } from "lucide-react";
      ...
      <div className="bg-[var(--deep-ocean-card)] border border-white/10 rounded-2xl w-full max-w-lg p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-white leading-tight">Alert Center</h2>
              <p className="text-[10px] uppercase font-bold tracking-widest text-[var(--text-muted)]">Real-time market intelligence</p>
            </div>
          </div>
        ...
        <div className="max-h-[60vh] overflow-y-auto space-y-3 pr-2 scrollbar-thin">
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-xs font-black text-[var(--text-muted)] uppercase tracking-widest">Intercepting Signals...</p>
            </div>
          ) : alerts.length === 0 ? (
            <div className="py-20 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-white font-black text-sm mb-1 uppercase tracking-wider">All Clear</p>
              <p className="text-xs text-[var(--text-muted)]">No critical market changes detected yet.</p>
            </div>
          ) : (
            alerts.map((alert) => (
              <div 
                ...
                <div className="flex justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className={`text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-[0.2em] ${
                        alert.alert_type === 'competitor_undercut' ? 'bg-red-500/20 text-red-400' : 'bg-[var(--soft-gold)]/20 text-[var(--soft-gold)]'
                      }`}>
