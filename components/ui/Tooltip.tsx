            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className={`absolute z-50 px-3 py-1.5 text-xs font-medium text-white bg-slate-900 border border-slate-800 rounded-lg shadow-xl whitespace-nowrap pointer-events-none ${sideClasses[side]} ${className}`}
                    >
                        {content}
                    </motion.div>
                )}
