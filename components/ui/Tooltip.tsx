            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className={`absolute z-50 px-3 py-1.5 text-xs font-medium text-[var(--overlay-text)] bg-[var(--bg-subtle)] border border-slate-800 rounded-lg shadow-xl pointer-events-none break-words ${sideClasses[side]} ${className}`}
                    >
                        {content}
                    </motion.div>
                )}
