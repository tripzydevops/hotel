        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {(pricing.plans?.length > 0 ? pricing.plans : [
              { name: t("subscription.starter.name"), price: t("subscription.price.starter"), period: t("subscription.period.mo"), description: t("subscription.starter.description"), features: [t("subscription.starter.features.0"), t("subscription.starter.features.1"), t("subscription.starter.features.2"), t("subscription.starter.features.3")], popular: false, cta: t("subscription.requestQuote") },
              { name: t("subscription.pro.name"), price: t("subscription.price.pro"), period: t("subscription.period.mo"), description: t("subscription.pro.description"), features: [t("subscription.pro.features.0"), t("subscription.pro.features.1"), t("subscription.pro.features.2"), t("subscription.pro.features.3"), t("subscription.pro.features.4")], popular: true, cta: t("subscription.requestQuote") },
              { name: t("subscription.enterprise.name"), price: t("subscription.price.enterprise"), period: t("subscription.period.custom"), description: t("subscription.enterprise.description"), features: [t("subscription.enterprise.features.0"), t("subscription.enterprise.features.1"), t("subscription.enterprise.features.2"), t("subscription.enterprise.features.3"), t("subscription.enterprise.features.4")], popular: false, cta: t("subscription.requestQuote") }
