...
export default function AdminScansPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--deep-ocean)] text-white p-6 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-center gap-3">
             <div className="relative group hidden md:block">
              ...
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-6 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--soft-gold)]/30 focus:border-[var(--soft-gold)]/30 transition-all w-64 group-hover:bg-white/10"
              />
            </div>
          </div>
        </div>
        ...
        {/* Footer info */}
        <div className="flex items-center justify-between pt-8 border-t border-white/5 text-[var(--text-muted)] text-[10px] uppercase font-black tracking-widest">
          <div className="flex items-center gap-4">
