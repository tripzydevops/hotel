...
class DemandScoringAgent:
    ...
    async def calculate_compression(self, city: str, target_date: date) -> Dict[str, Any]:
        """
        ...
        """
        logger.info(f"[DemandScoringAgent] Calculating compression for {city} on {target_date}")
    ...
    def _get_level(self, score: int) -> str:
        ...
        if score >= 4: return "Active (Normal Demand)"
